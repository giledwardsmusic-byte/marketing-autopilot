...
const expected=process.env.MA_RELEASE_ID||'2026-08-25-social-oauth-v1';
...
const required=['instagram_from_facebook','pinterest_oauth','tiktok_oauth','google_drive_sync','paid_sale_email_alerts','unresolved_health_email_alerts','media_normalization','media_quota_fallback','invalid_media_fail_closed'];
